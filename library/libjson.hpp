...
namespace libjson {
    ...
    */
        ...
        */
        ...
        public:
            ...
            std::string & asString() {
                ...
                m_iter->second.typeConversionError( m_iter->first, "string" );
            }
    ...
    private:
        void typeConversionError( const std::string & a_type ) const {
            throw std::runtime_error( std::string( "Invalid conversion of " ) + getTypeString() + " to " + a_type );
        }

        void typeConversionError( const std::string & a_key, const std::string & a_type ) const {
